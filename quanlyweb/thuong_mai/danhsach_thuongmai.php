					...
					<div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
						<div>
							...
							<p class="breadcrumbs"><span><a href="index.html">Trang chủ</a></span>
								...
								<span><i class="mdi mdi-chevron-right"></i></span>Danh sách slide
							</p>
						</div>
					</div>
					<div class="row">
	...
	<?php
						...
						$result = mysqli_query($link, "SELECT * FROM thuong_mai ORDER BY id DESC limit $start,$limit");
						$stt = 1;
						?>
										...
										<table id="responsive-data-table" class="table" style="width:100%">
											...
											<tbody class="text-center">
												...
												while ($row = mysqli_fetch_object($result)) {
													...
													$did = $row->thuocloai;
													$sql3 = mysqli_query($link, "select * from thuong_mai where id='" . $did . "'");
													...
													<tr>
														...
														<td>
															<a href="quan_tri.php?p=xoa_thuongmai&id=<?= $id ?>"
														...
														<td>
															<a
																href="quan_tri.php?p=sua_thuongmai&id=<?= $id ?>&thuocloai=1&page=<?= $_GET['page'] ?>">
