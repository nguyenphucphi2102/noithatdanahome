    ...
    <div class="content">
      ...
      <div class="row">
        ...
        function upload($thuocloai, $thuocloai_en, $tentaptin, $id, $linkurl)
        {
            ...
            $sql = "UPDATE loai_tin_sanphama SET
                        `thuocloai` = '$thuocloai',
            ...
            echo "<script>
                    ...
                    setTimeout(() => {
                      window.location = 'quan_tri.php?p=danhsach_loai_tinsanphama&page=" . $_GET["page"] . "';
                    }, 2000);
                  </script>";
        }
        ...
        include('db.php');
        $id = $_REQUEST["id"];
        $result = mysqli_query($link, "SELECT * FROM loai_tin_sanphama WHERE id = '$id'");
