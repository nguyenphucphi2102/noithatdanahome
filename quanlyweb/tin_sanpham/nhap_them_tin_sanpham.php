      ...
      <div class="content">
        ...
        <div class="row">
          ...
          if (isset($_POST['luu'])) {
            ...
            upload($noidung, $tentaptin, $tenhinhanh1, $tenhinhanh2, $tenhinhanh3, $tieude, $mota, $trangchu, $thuocloai, $tieude_en, $title, $tukhoa, $tukhoa2, $ngay, $linkurl);
          ...
          function upload($noidung, $tentaptin, $tenhinhanh1, $tenhinhanh2, $tenhinhanh3, $tieude, $mota, $trangchu, $thuocloai, $tieude_en, $title, $tukhoa, $tukhoa2, $ngay, $linkurl)
          {
            require('db.php');

            // Xử lý đặc biệt với ký tự trong câu truy vấn
            $truyvan = "INSERT INTO tin_sanphama (`hinhanh`,`hinhanh1`,`hinhanh2`,`hinhanh3`,`noidung`,`trangchu`,`mota`,`tieude`, `tieude_en`, `title`, `tukhoa`,`tukhoa2`,`ngay`,`linkurl`,`thuocloai`,`moi`) VALUES ( '$tentaptin', '$tenhinhanh1','$tenhinhanh2','$tenhinhanh3', '$noidung', '$trangchu', '$mota','$tieude', '$tieude_en', '$title', '$tukhoa','$tukhoa2','$ngay', '$linkurl','$thuocloai','0')";
