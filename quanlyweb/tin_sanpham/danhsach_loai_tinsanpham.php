	...
	<div class="ec-content-wrapper">
		<div class="content">
			...
			<div class="row">
				...
				$count = mysqli_num_rows(mysqli_query($link, "SELECT*FROM loai_tin_sanpham"));

				$pages = $p->findPages($count, $limit);

				$result = mysqli_query($link, "SELECT * FROM loai_tin_sanpham ORDER BY id ASC limit $start,$limit");
				?>
				<div class="col-12">
