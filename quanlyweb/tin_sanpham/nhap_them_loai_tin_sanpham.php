    ...
    <div class="content">
      ...
      <div class="row">
        ...
        if (isset($_POST['luu'])) {
          ...
          echo "<script>window.location='quan_tri.php?p=danhsach_loai_tinsanpham" . $_GET["page"] . "'</script>";

        }
        function upload($thuocloai, $thuocloai_en, $tentaptin, $url)
        {
          require('db.php');
          $truyvan = " INSERT INTO loai_tin_sanpham (thuocloai,thuocloai_en,trangchu,hinhanh,logo,noidung,noidung_en,name_url) VALUES ('" . $thuocloai . "', '" . $thuocloai_en . "','0','" . $tentaptin . "','','','','" . $url . "')";
        ...
        function xoataptin($tentaptin)
        {
          ...
          $truyvan = "DELETE FROM loai_tin_sanpham WHERE hinhanh = '$tentaptin'";
