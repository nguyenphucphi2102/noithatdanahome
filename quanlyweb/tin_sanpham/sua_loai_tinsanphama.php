  ...
  <div class="ec-content-wrapper">
    <div class="content">
      <div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
        ...
        <div>
          <a href="quan_tri.php?p=them_tin_sanphama" class="btn btn-primary"> Thêm dịch vụ
          </a>
        </div>
      </div>
      <div class="row">
        ...
        function upload($thuocloai, $tukhoa1, $tukhoa2, $tentaptin, $noidung, $id, $url)
        {
          ...
          $truyvan = "update  loai_tin_sanpham set `thuocloai` = '$thuocloai' , `tukhoa1` = '$tukhoa1' , `tukhoa2` = '$tukhoa2' , `thuocloai_en` = '' , `hinhanh` = '$tentaptin' , `logo` = '', `noidung` = '$noidung' , `name_url` = '$url' , `noidung_en` = '' where id='$id'";
        ...
        function xoataptin($tentaptin)
        {
          ...
          $truyvan = "DELETE FROM tin_sanpham WHERE filename = '$tentaptin'";
        ...
        include('db.php');
        $id = $_REQUEST["id"];
        $result = mysqli_query($link, "SELECT * FROM loai_tin_sanpham where id like '$id' ");
