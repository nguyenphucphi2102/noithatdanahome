    ...
    <div class="content">
      ...
      <div class="row">
        ...
        if (isset($_POST['luu'])) {
          ...
          $tieude = str_replace("'", "", $_POST['tieude_en']);
          ...
          $truyvan = "UPDATE `tin_thicong` SET $fileup
                    `thuocloai` = '$thuocloai',
                    `noidung` = '$noidung',
                    `trangchu` = '',
                    `mota` = '$mota',
          ...
          echo "<script>window.location='quan_tri.php?p=ds_tin_thicong&page=" . $_GET["page"] . "'</script>";
          if ($result) {
            if ($fileup != '') {
