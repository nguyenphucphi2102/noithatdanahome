			...
			<div class="ec-content-wrapper">
				<div class="content">
					<div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
						...
						<div>
							<a href="quan_tri.php?p=nhap_them_loai_tin_thicong" class="btn btn-primary"> Thêm loại tin tức</a>
						</div>
					</div>
					<div class="row">
						...
						$count = mysqli_num_rows(mysqli_query($link, "SELECT*FROM loai_tin_thicong "));

						$pages = $p->findPages($count, $limit);

						$result = mysqli_query($link, "SELECT * FROM loai_tin_thicong ORDER BY id ASC limit $start,$limit");
						?>
