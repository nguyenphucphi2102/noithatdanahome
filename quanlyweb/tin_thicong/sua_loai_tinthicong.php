      ...
      <div class="ec-content-wrapper">
        <div class="content">
          <div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
            ...
            <div>
              <a href="quan_tri.php?p=them_tin_thicong" class="btn btn-primary"> Thêm tin tức
              </a>
            </div>
          </div>
          <div class="row">
            ...
            function upload($thuocloai, $tentaptin, $noidung, $id, $url)
            {
              ...
              $truyvan = "update  loai_tin_thicong set `thuocloai` = '$thuocloai' , `thuocloai_en` = '' , `hinhanh` = '$tentaptin' , `logo` = '', `noidung` = '$noidung' , `name_url` = '$url' , `noidung_en` = '' where id='$id'";

              $ketqua_truyvan = mysqli_query($link, $truyvan);
              echo "<script>window.location='quan_tri.php?p=danhsach_loai_tinthicong&page=" . $_GET["page"] . "'</script>";
              if ($ketqua_truyvan) {
            ...
            function xoataptin($tentaptin)
            {
              ...
              $truyvan = "DELETE FROM tin_thicong WHERE filename = '$tentaptin'";
            ...
            include('db.php');
            $id = $_REQUEST["id"];
            $result = mysqli_query($link, "SELECT * FROM loai_tin_thicong where id like '$id' ");
