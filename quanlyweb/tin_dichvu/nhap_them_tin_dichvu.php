...
if (isset($_POST['luu'])) {
    ...
    $tieude_en  = mysqli_real_escape_string($link, !empty($_POST['tieude_en']) ? $_POST['tieude_en'] : '');
    ...
    upload($noidung, $tentaptin, $tieude, $tieude_en, $mota, $thuocloai, $tukhoa, $ngay, $linkurl);
    ...
    echo "<script>
      ...
      setTimeout(() => {
        window.location = 'quan_tri.php?p=ds_tin_dichvu&page=" . $page . "';
      }, 2000);
    </script>";
    exit;
}

function upload($noidung, $tentaptin, $tieude, $tieude_en, $mota, $thuocloai, $tukhoa, $ngay, $linkurl)
{
    require('db.php');
