	...
	<div class="ec-content-wrapper">
		<div class="content">
			<div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
				...
				<div>
					<a href="quan_tri.php?p=nhap_them_loai_tin_dichvu" class="btn btn-primary"> Thêm loại dịch vụ</a>
				</div>
			</div>
			<div class="row">
									...
									<tbody>
										...
										while ($row = mysqli_fetch_object($result)) {
											...
											<tr>
												...
												<td>
													<a href="quan_tri.php?p=xoa_loai_tindichvu&id=<?= $id ?>"
												...
												<td>
													<a
														href="quan_tri.php?p=sua_loai_tindichvu&id=<?= $id ?>&thuocloai=1&page=<?= $_GET['page'] ?>">
