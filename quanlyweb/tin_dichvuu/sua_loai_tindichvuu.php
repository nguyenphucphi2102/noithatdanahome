      ...
      <div class="row">
        ...
        function upload($thuocloai,$tukhoa1,$tukhoa2, $tentaptin, $noidung, $id, $url)
        {
          ...
          ///chon_CSDL($ketnoi_maychu);
           $truyvan = "update  loai_tin_dichvuu set `thuocloai` = '$thuocloai' , `tukhoa1` = '$tukhoa1' , `tukhoa2` = '$tukhoa2' , `thuocloai_en` = '' , `hinhanh` = '$tentaptin' , `logo` = '', `noidung` = '$noidung' , `name_url` = '$url' , `noidung_en` = '' where id='$id'";
