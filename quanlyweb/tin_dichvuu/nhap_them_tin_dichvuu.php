      ...
      <div class="content">
        ...
        <div class="row">
          ...
          function upload($noidung, $tentaptin, $tenhinhanh1, $tenhinhanh2, $tenhinhanh3, $tieude, $mota, $trangchu, $thuocloai, $tieude_en, $title, $tukhoa, $tukhoa2, $ngay, $linkurl)
          {
            ...
            $truyvan = "INSERT INTO tin_dichvuu (`hinhanh`,`hinhanh1`,`hinhanh2`,`hinhanh3`,`noidung`,`trangchu`,`mota`,`tieude`, `tieude_en`, `title`, `tukhoa`,`tukhoa2`,`ngay`,`linkurl`,`thuocloai`,`moi`) VALUES ( '$tentaptin', '$tenhinhanh1','$tenhinhanh2','$tenhinhanh3', '$noidung', '$trangchu', '$mota','$tieude', '$tieude_en', '$title', '$tukhoa','$tukhoa2','$ngay', '$linkurl','$thuocloai','0')";
