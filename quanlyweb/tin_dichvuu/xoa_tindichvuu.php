...
include("db.php");
$result = mysqli_query($link, "SELECT * FROM tin_dichvuu WHERE id = '$_GET[id]' ");
...
$chuoi = "DELETE FROM tin_dichvuu WHERE id = '$_GET[id]' ";

mysqli_query($link, $chuoi);

echo "<form name='frm_dangnhap'>

			        <input type'hidden' name='chuyentrang' value='quan_tri.php?p=ds_tin_dichvuu'>
