			...
			<div class="ec-content-wrapper">
				<div class="content">
					...
					<div class="row">
						...
						// Truy vấn tổng số bài tin tức
						$query = "SELECT COUNT(*) AS tongtintuc FROM tin_tintuc";
						$result = mysqli_query($link, $query);
						$row = mysqli_fetch_assoc($result);
						$tongtintuc = $row['tongtintuc'];
						?>

						<div class="col-xl-4 col-sm-6 p-b-15 lbl-card">
							<div class="card card-mini dash-card card-1">
								<div class="card-body">
									<h2 class="mb-1"><?php echo number_format($tongtintuc); ?></h2>
						...
						// Truy vấn tổng số bài tin tức
						$query = "SELECT COUNT(*) AS tong_tindichvu FROM tin_dichvu";
						$result = mysqli_query($link, $query);
						$row = mysqli_fetch_assoc($result);
						$tong_tindichvu = $row['tong_tindichvu'];
						?>

						<div class="col-xl-4 col-sm-6 p-b-15 lbl-card">
							<div class="card card-mini dash-card card-1">
								<div class="card-body">
									<h2 class="mb-1"><?php echo number_format($tong_tindichvu); ?></h2>
						...
						// Truy vấn tổng số bài tin tức
						$query = "SELECT COUNT(*) AS tong_sanpham FROM ma_sanpham";
						$result = mysqli_query($link, $query);
						$row = mysqli_fetch_assoc($result);
						$tong_sanpham = $row['tong_sanpham'];
						?>

						<div class="col-xl-4 col-sm-6 p-b-15 lbl-card">
							<div class="card card-mini dash-card card-1">
								<div class="card-body">
									<h2 class="mb-1"><?php echo number_format($tong_sanpham); ?></h2>
