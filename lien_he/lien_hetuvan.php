...
if (isset($_POST['luu'])) {
    ...
    try {
        ...
        $mail->addAddress('kinhdoanhatv@gmail.com', 'Recipient Name');
...
<section class="titlelienheatv">
    ...
    <section class="container" style='padding:0px;'>
        ...
        <article class="titlelienheatv-form">
           ...
           <form id="tt_mh_tuvan" name="tt_mh_tuvan" method="post" action="xulylienhe/xuly_lienhe.php"  onsubmit="return checkInput();">
